        ...
        <v-layout row wrap v-else>
            <v-flex xs12>
                <v-card>
                    ...
                    <v-card-media :src="meetup.imageUrl" height="500px"></v-card-media>
                    <v-card-text>
                    ...
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <app-register-meetup-dialog :meetupId="meetup.id" v-if="userIsAuthenticated && !userIsCreator"></app-register-meetup-dialog>
                    </v-card-actions>
                </v-card>
            </v-flex>
        </v-layout>
